...
public class Table implements Serializable{
    ...
    public void updateCOLUMN(String column,String new_column_value,String column_to_check,String operand,String operation,HashMap<String,ROW> ar1){

            UPDATE_FOR_ROW up1 = new UPDATE_FOR_ROW(row,this.column_name);
            up1.updateROW(this,column,new_column_value,column_to_check,operation,operand,ar1);
    }
}
